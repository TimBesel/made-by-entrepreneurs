<template>
  <div class="nav" id="navbar">
    <nav class="nav__container" :class="{ 'nav__container-collapse': collapse }">
      <div>
        <div class="nav__list">
          <div class="nav_items" ref="menuItems">
            <!---->
            <!-- #################### side Menu Items #################### -->
            <!---->
            <menu-item icon="el-icon-s-data" link="/dashboard">Dashboard</menu-item>
            ...
            <sub-menu icon="el-icon-money" title="Invoice" link="/invoice">
              ...
              <sub-menu-item icon="el-icon-folder-opened" link="/invoice/saved">Saved</sub-menu-item>
              <sub-menu-item icon="el-icon-edit" link="/invoice/edit">Edit</sub-menu-item>
            </sub-menu>
            <!---->
            <!-- ######################################################### -->
            <!---->
...
.nav__container-collapse {
  max-width: var(--nav-collapse-width);
  transition: 0.4s;
  transition-property: max-width;
}
